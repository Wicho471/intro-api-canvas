function drawCuadrado() {
  ...
  function drawCarita() {
    const canvas = document.getElementById("carita");
    if (canvas.getContext) {
      const ctx = canvas.getContext("2d");
  ...
  function drawTriangulos() {
    const canvas = document.getElementById("triangulos");
    if (canvas.getContext) {
      const ctx = canvas.getContext("2d");
  ...
  function drawRectuangulos() {
    const canvas = document.getElementById("rectangulos");
    if (canvas.getContext) {
      const ctx = canvas.getContext("2d");
